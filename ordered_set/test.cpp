...
// in here (less) means for arranging elements in ascending order, if we greater instead it will print it in descending order, 
// and if we use (less_equal) for duplicate elements.
